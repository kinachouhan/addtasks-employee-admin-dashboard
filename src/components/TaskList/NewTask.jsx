export const NewTask = ({data})=>{
        return(
            <div className="bg-blue-400 w-[350px] h-full rounded-xl shrink-0 p-5">
                ...
                <div className="flex gap-2 text-sm mt-4">
                    <button className="bg-green-500 py-2 px-4 rounded-sm">Accepted</button>
                    <button className="bg-red-500 py-2 px-4 rounded-sm">Rejected</button>
                </div>
            </div>
        )
}